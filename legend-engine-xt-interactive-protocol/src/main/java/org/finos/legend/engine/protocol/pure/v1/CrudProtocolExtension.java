...
public class CrudProtocolExtension implements PureProtocolExtension
{
    @Override
    public List<Function0<List<ProtocolSubTypeInfo<?>>>> getExtraProtocolSubTypeInfoCollectors()
    {
        return Lists.fixedSize.of(() -> Lists.fixedSize.of(
                ProtocolSubTypeInfo.Builder
                        ...
                        .withSubtypes(Lists.fixedSize.of(Tuples.pair(InteractiveApplication.class, "interactiveApplication")))
                        .build()
        ));
    }
    ...
    public Map<Class<? extends PackageableElement>, String> getExtraProtocolToClassifierPathMap()
    {
        return Maps.mutable.with(
                InteractiveApplication.class, "meta::pure::crud::metamodel::InteractiveApplication");
    }
}
